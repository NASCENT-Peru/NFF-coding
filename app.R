  ...
  output$intro_content <- renderUI({
    ...
    if (selected_language() == "en") {
      tagList(
        ...
        tags$br(),
        tags$br(),
        img(src = "Introduction/Intro_EN.png", height = "80%", width = "80%", style = "box-shadow: 0px 0px 5px black; display: block; margin-left: auto; margin-right: auto;"),
        tags$br(),
        tags$br(),
      ...
      tagList(
        ...
        tags$br(),
        tags$br(),
        img(src = "Introduction/Intro_ES.png", height = "80%", width = "80%", style = "box-shadow: 0px 0px 5px black; display: block; margin-left: auto; margin-right: auto;"),
        tags$br(),
        tags$br(),
